...
void DrawControlBase::setInDiv(bool value)
{
    isIndiv = value;
}
void DrawControlBase::setRelVal(bool value)
{
    isRelVal = value;
}
void DrawControlBase::setUpperValue(int value){
    upperValue = value;
}
void DrawControlBase::setLowerValue(int value){
    lowerValue = value;
}
