...
Control {
    ...
    */
    ...
    property bool rightToLeftLayout: false
    ...
    RangedDate {
        id: rangedDate
        date: new Date()
        minimumDate: CalendarBaseUtils.minimumCalendarDate
        maximumDate: CalendarBaseUtils.maximumCalendarDate
    }
    ...
    */
    ...
    style: Settings.styleComponent(Settings.style, "CalendarBaseStyle.qml", calendar)
    ...
    */
    function showPreviousMonth() {
        if (visibleMonth === 0) {
            visibleMonth = CalendarBaseUtils.monthsInAYear - 1;
            --visibleYear;
        } else {
            --visibleMonth;
        }
    ...
    */
    function showNextMonth() {
        if (visibleMonth === CalendarBaseUtils.monthsInAYear - 1) {
            visibleMonth = 0;
            ++visibleYear;
        } else {
            ++visibleMonth;
    ...
    */
    function __selectPreviousMonth() {
        calendar.selectedDate = CalendarBaseUtils.setMonth(calendar.selectedDate, calendar.selectedDate.getMonth() - 1);
    }
    ...
    */
    function __selectPreviousWeek() {
        ...
        newDate.setDate(newDate.getDate() - CalendarBaseUtils.daysInAWeek);
    ...
    */
    function __selectLastDayOfMonth() {
        var newDate = new Date(calendar.selectedDate);
        newDate.setDate(CalendarBaseUtils.daysInMonth(newDate));
        calendar.selectedDate = newDate;
    }
