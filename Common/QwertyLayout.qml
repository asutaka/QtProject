...
Item {
    ...
    property var keyObj: Qt.createComponent("../Common/KeyButton.qml");
    ...
    Rectangle{
        ...
        KeyButton{
            ...
            colorKey: "#696969"
            widthKey: 105
            sourceKey: "../Images/keyboard_shift.png"
            viewImage: true
        ...
        KeyButton{
            ...
            onClicked: {
                isKana = !isKana
                isFistJp =true
                btnNextPanel.sourceKey= "../Images/keyboard_nextPanel.png";
        ...
        KeyButton{
            ...
            y: 220
            colorKey: "#696969"
            sourceKey: "../Images/changeLanguage.png"
            viewImage: true
        ...
        KeyButton{
            ...
            y: 220
            colorKey: "#696969"
            sourceKey: "../Images/nextMouse.png"
            viewImage: true
            txtKey:"Next Mouse"
        ...
        KeyButton{
            ...
            y: 220
            colorKey: "#696969"
            sourceKey: "../Images/keyboard_enter2.png"
            viewImage: true
            txtKey:"Enter"
        ...
        KeyButton {
            ...
            widthKey: 105
            viewImage: true
            sourceKey: "../Images/keyboard_del.png"
            txtKey: "Delete"
        ...
        KeyButton{
            ...
            y: 150
            colorKey: "#696969"
            sourceKey: "../Images/keyboard_nextPanel.png"
            viewImage: true
            visible: ((!isNumber)&&(!isEnglish))
            txtKey:"次"
            onClicked: {
                ...
                if(isFistJp){
                    ...
                    btnNextPanel.sourceKey= "../Images/keyboard_backPanel.png";
