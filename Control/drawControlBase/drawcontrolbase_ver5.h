#ifndef DRAWCONTROLBASE_VER5_H
#define DRAWCONTROLBASE_VER5_H
...
class DrawControlBase_ver5 : public QQuickPaintedItem
{
    Q_OBJECT
public:
    DrawControlBase_ver5(QQuickItem* parent = 0);
    ~DrawControlBase_ver5();
