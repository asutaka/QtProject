...
import "CalendarBaseUtils.js" as CalendarBaseUtils
...
Style {
    ...
    */
    readonly property CalendarBase control: __control
    ...
    */
    ...
    function __cellRectAt(index) {
        return CalendarBaseUtils.cellRectAt(index, control.__panel.columns, control.__panel.rows,
            control.__panel.availableWidth, control.__panel.availableHeight, gridVisible ? __gridLineWidth : 0);
    }

    function __cellRectAtRightToLeft(index) {
        return CalendarBaseUtils.cellRectAtRightToLeft(index, control.__panel.columns, control.__panel.rows,
            control.__panel.availableWidth, control.__panel.availableHeight, gridVisible ? __gridLineWidth : 0);
    }
    ...
    */
    property Component dayDelegate: Rectangle {
        anchors.fill: parent
        anchors.leftMargin: (!addExtraMargin || control.weekNumbersVisible) && styleData.index % CalendarBaseUtils.daysInAWeek === 0 ? 0 : -1
        anchors.rightMargin: !addExtraMargin && styleData.index % CalendarBaseUtils.daysInAWeek === CalendarBaseUtils.daysInAWeek - 1 ? 0 : -1
        anchors.bottomMargin: !addExtraMargin && styleData.index >= CalendarBaseUtils.daysInAWeek * (CalendarBaseUtils.weeksOnACalendarMonth - 1) ? 0 : -1
    ...
    */
    ...
    property Component panel: Item {
        ...
        readonly property int columns: CalendarBaseUtils.daysInAWeek
                ...
                Item {
                    ...
                    Repeater {
                        ...
                        delegate: Loader {
                            ...
                            x: !control.rightToLeftLayout ? __cellRectAt(index).x : __cellRectAtRightToLeft(index).x
