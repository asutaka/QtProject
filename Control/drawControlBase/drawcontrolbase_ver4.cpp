#include "drawcontrolbase_ver4.h"
#include <QDebug>
#include <QDateTime>

DrawControlBase_ver4::DrawControlBase_ver4(QQuickItem *parent)
...
DrawControlBase_ver4::~DrawControlBase_ver4()
{
    delete timerDateTime;
    delete timerDrawing;
}
void DrawControlBase_ver4::paint(QPainter *painter)
{
    drawTimer.restart();
    DrawCom1(painter);
    DrawCom2(painter);
...
void DrawControlBase_ver4::updateDraw()
{
    this->update();
}

void DrawControlBase_ver4::updateTime()
{
...
void DrawControlBase_ver4::DrawCom1(QPainter *qp)
{
    //draw border line com1
    QPainterPath path;
    QBrush greyBrush(QColor(41,49,60));
...
void DrawControlBase_ver4::DrawCom2(QPainter *qp)
{
...
void DrawControlBase_ver4::DrawCom3(QPainter *qp)
{
...
void DrawControlBase_ver4::setNumSelect(int _lineNo,int _numSelect)
{
    lineNo =_lineNo;
    numSelect=_numSelect;
}

void DrawControlBase_ver4::getIsLeft(bool _isLeft, int _btnID, int _screenID)
{
    if (_screenID == 4) {
        switch (_btnID) {
        case 0:
...
void DrawControlBase_ver4::getCurrentLine(int _currentLine)
{
    currentLine = _currentLine;
    this->update();
}
void DrawControlBase_ver4::getIntervalValue(int _interval)
{
    timerDrawing->stop();
