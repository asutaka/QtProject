#include "drawcontrolbase_ver2.h"
#include <QDebug>
#include <QDateTime>

DrawControlBase_Ver2::DrawControlBase_Ver2(QQuickItem *parent)
...
DrawControlBase_Ver2::~DrawControlBase_Ver2()
{
}
void DrawControlBase_Ver2::paint(QPainter *painter)
{
...
void DrawControlBase_Ver2::updateDraw()
{
    this->update();
}

void DrawControlBase_Ver2::DrawCom1(QPainter *qp)
{
    pen.setColor(QColor(166, 166, 166));
    qp->setPen(pen);
...
void DrawControlBase_Ver2::DrawCom2(QPainter *qp)
{
    pen.setColor(QColor(166, 166, 166));
    qp->setPen(pen);
...
void DrawControlBase_Ver2::DrawCom3(QPainter *qp)
{
    pen.setColor(QColor(166, 166, 166));
    qp->setPen(pen);
...
void DrawControlBase_Ver2::getIsLeft(bool _isLeft, int _btnID, int _screenID)
{
    if (_screenID == 4) {
        switch (_btnID) {
        case 0:
...
void DrawControlBase_Ver2::getCurrentLine(int _currentLine)
{
