...
const QMetaObject MenuList::staticMetaObject = {
    { &QQuickPaintedItem::staticMetaObject, qt_meta_stringdata_MenuList.data,
      qt_meta_data_MenuList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MenuList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MenuList.stringdata0))
        return static_cast<void*>(const_cast< MenuList*>(this));
